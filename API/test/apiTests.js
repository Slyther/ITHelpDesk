    ...
    describe('Users Endpoint', () => {
        describe('/POST', () => {
            it('should POST a new test user', async () => {
                ...
                .send({username: 'Chai Test User', email: 'chai@test.com', password: 'chaitestpassword', role: 'admin'});
            ...
            it('should POST an error due to username already being in use', async () => {
                ...
                .post('/api/users/register')
                .send({username: 'Chai Test User', email: 'chai1@test.com', password: 'chaitestpassword', role: 'admin'});
                expect(res).to.have.status(200);
                expect(res.body).to.be.a('object');
